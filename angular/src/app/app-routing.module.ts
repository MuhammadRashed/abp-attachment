...
const routes: Routes = [
  ...
  { path: 'attachments', loadChildren: () => import('./attachments/attachment/attachment.module').then(m => m.AttachmentModule) },
  { path: 'attachment-details', loadChildren: () => import('./attachments/attachment-detail/attachment-detail.module').then(m => m.AttachmentDetailModule) },
];
